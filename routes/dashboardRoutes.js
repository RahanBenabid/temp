...
router.get("/artisan", authenticate, isArtisan, DashboardController.getArtisanDashboard);
router.get("/supplier", authenticate, isSupplier, DashboardController.getSupplierDashboard);
router.get("/delivery", authenticate, isDeliveryMan, DashboardController.getDeliveryDashboard);
